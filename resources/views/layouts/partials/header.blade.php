                                    ...
                                    <ul>
                                        <li>
                                            <a href="#"><i class="fas fa-phone-alt"></i>
                                                {{ $cmpd->company_phone }}</a>
                                        </li>
                                        <li>
                                            <a href="mailto:{{ $cmpd->company_email }}"><i class="fas fa-envelope"></i>
                                                {{ $cmpd->company_email }}</a>
                                        </li>
                                        <li>
            ...
            <div class="bottom-header sticky">
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <div class="header-btn">
                        <a href="{{ URL::route('packages') }}" class="button-primary">BOOK NOW</a>
                    </div>
                </div>
            </div>
