...
@section('content')
    ...
    <main id="content" class="site-main">
            ...
            <div class="inner-baner-container"
                ...
                <div class="container">
                    <div class="inner-banner-content">
                        <h1 class="inner-title">Tour Operators</h1>
                    </div>
                </div>
            </div>
        ...
        {{-- {{ $packages }} --}}
        <div class="guide-package-section">
            <div class="container">
                <div class="row" id="operator-post">
                    {{-- Ajax responses will be displayed here --}}
                </div>
            </div>
            <div class="text-center m-3">
                <button class="btn btn-primary" id="load-more-operator" data-paginateo="2">Load more...</button>
                <p class="invisible">No more operators...</p>
            </div>
        </div>
