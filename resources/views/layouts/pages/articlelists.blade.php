...
<!-- Inner Banner html start-->
    <section class="inner-banner-wrap">
        <div class="inner-baner-container" style="background-image: url('{{ asset('assets/images/default/article-banner2.jpg')}}');">
            <div class="container">
                <div class="inner-banner-content">
                <h1 class="inner-title">Travel Articles</h1>
                </div>
            </div>
        </div>
    ...
    <div class="package-section">
        <div class="container">
            <div class="package-inner">
                <div class="row" id="articles-post">
                    {{-- Ajax responses will be displayed here --}}
                </div>
            </div>
        </div>
        <div class="text-center m-3">
            <button class="btn btn-primary" id="load-more-articles" data-paginatea="2">Load more...</button>
