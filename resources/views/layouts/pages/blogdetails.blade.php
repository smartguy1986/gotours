        ...
        <section class="inner-banner-wrap">
            @if (!empty($blogs[0]->blog_banner))
                <div class="inner-baner-container"
                    style="background-image: url('{{ asset('images/blogs/' . $blogs[0]->blog_banner) }}');">
                @else
                    <div class="inner-baner-container"
                        style="background-image: url('{{ asset('assets/images/default/article-banner2.jpg') }}');">
            @endif
            <div class="container">
                                    ...
                                    <div class="widget-content text-center">
                                        <div class="profile">
                                            <figure class="avatar">
                                                <a href="#">
                                                    @if ($blogs[0]->author == '1')
                                                        <img src="{{ URL::asset('assets/images/user-img.png') }}"
                                                            alt="">
                                                    @else
                                                        <img src="{{ URL::asset('assets/images/user-img.png') }}"
                                                            alt="">
                                        ...
                                        @foreach ($related_blogs as $rp)
                                            <li>
                                                <figure class="post-thumb">
                                                    <a href="{{ URL::route('blog.details', $rp->slug) }}"><img
                                                            src="{{ URL::asset('/images/blogs/' . $rp->blog_image) }}"
                                                            alt="{{ $rp->title }}"></a>
                                                </figure>
                                                <div class="post-content">
                                                    <h5>
                                                        <a
                                                            href="{{ URL::route('blog.details', $rp->slug) }}">{{ $rp->title }}</a>
                                                    </h5>
                                                    <div class="entry-meta">
                                                        <span class="posted-on">
                                                            <a
                                                                href="{{ URL::route('blog.details', $rp->slug) }}">{{ date('dS M, Y', strtotime($rp->created_at)) }}</a>
                                                        </span>
                                                        {{-- <span class="comments-link">
