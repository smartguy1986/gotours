                                    ...
                                    @foreach ($related_blogs as $rp)
                                        <li>                                        
                                            <figure class="post-thumb">
                                                <a href="{{URL::route('blog.details',$rp->slug)}}"><img src="{{URL::asset('/images/blogs/'.$rp->blog_image)}}" alt="{{ $rp->title }}"></a>
                                            </figure>
                                            <div class="post-content">
                                                <h5>
                                                    <a href="{{URL::route('blog.details',$rp->slug)}}">{{ $rp->title }}</a>
                                                </h5>
                                                <div class="entry-meta">
                                                    <span class="posted-on">
                                                        <a href="{{URL::route('blog.details',$rp->slug)}}">{{ date('dS M, Y', strtotime($rp->created_at)) }}</a>
                                                    </span>
                                                    {{-- <span class="comments-link">
