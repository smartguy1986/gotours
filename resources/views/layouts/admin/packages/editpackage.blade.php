                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control dropdown" name="agency_id">
                                        @foreach ($agencies as $agn)
                                            @if ($agn->id == $packages[0]->agency_id)
                                                <option value="{{ $agn->id }}" selected>{{ $agn->agency_name }}</option>
                                            @else
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control dropdown" name="days">
                                        @for ($i = 1; $i <= 15; $i++)
                                            <option {{ $packages[0]->days == $i ? 'selected' : null }}
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control dropdown" name="nights">
                                        @for ($j = 1; $j <= 15; $j++)
                                            <option value="{{ $j }}"
                                                {{ $packages[0]->nights == $j ? 'selected' : null }}>{{ $j }}
                                                Nights
                                            </option>
                                        @endfor
                                    </select>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" aria-label="Default select example" name="mingroup">
                                        <option value="Solo" {{ $packages[0]->mingroup == 'Solo' ? 'selected' : '' }}>
                                            Solo</option>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    No <input class="form-input-control" type="radio" name="is_sale" value="0"
                                        ...
                                        {{ $packages[0]->is_sale == '0' ? 'checked' : null }}> |
                                    Yes <input class="form-input-control" type="radio" name="is_sale" value="1"
                                        style="width: auto !important;"
                                        {{ $packages[0]->is_sale == '1' ? 'checked' : null }}>
                                    @error('is_sale')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label>Status</label>
                                    Active <input class="form-input-control" type="radio" name="status"
                                        value="1" style="width: auto !important;"
                                        @if ($packages[0]->status == 1) checked @endif> |
                                    Inactive <input class="form-input-control" type="radio" name="status"
                                        value="0" style="width: auto !important;"
                                        @if ($packages[0]->status == 0) checked @endif>
                                    @error('status')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
