...
Route::get('careerdetails/{package}', [CareersController::class, 'show'])->name('careerdetails');
...
Route::get('/wishlist/{package}', [WishlistsController::class, 'create'])->name('packages.whishlist');
...
Route::middleware(['auth', 'user-access:admin'])->group(function () {
    ...
    Route::put('/admin/company/update/{package}', [CompanyDetailsController::class, 'update'])->name('company.update');
    ...
    Route::get('/admin/company/banners/{package}/{filename}', [CompanyBannersController::class, 'delete_banners'])->name('company.banners.delete');
    ...
    Route::get('/admin/destinations/edit/{package}', [DestinationsController::class, 'edit'])->name('destinations.edit');
    Route::post('/admin/destinations/update', [DestinationsController::class, 'update'])->name('destinations.update');
    Route::get('/admin/destinations/disable/{package}', [DestinationsController::class, 'disable'])->name('destinations.disable');
    ...
    Route::get('/admin/services/edit/{package}', [ServicesController::class, 'edit'])->name('services.edit');
    Route::post('/admin/services/update', [ServicesController::class, 'update'])->name('services.update');
    Route::get('/admin/services/disable/{package}', [ServicesController::class, 'disable'])->name('services.disable');
    ...
    Route::get('/admin/testimonials/edit/{package}', [TestimonialController::class, 'edit'])->name('testimonials.edit');
    Route::post('/admin/testimonials/update', [TestimonialController::class, 'update'])->name('testimonials.update');
    Route::get('/admin/testimonials/disable/{package}', [TestimonialController::class, 'disable'])->name('testimonials.disable');
    ...
    Route::get('/admin/faqs/edit/{package}', [FaqsController::class, 'edit'])->name('faqs.edit');
    Route::post('/admin/faqs/update', [FaqsController::class, 'update'])->name('faqs.update');
    Route::get('/admin/faqs/disable/{package}', [FaqsController::class, 'disable'])->name('faqs.disable');
    ...
    Route::get('/admin/career/edit/{package}', [CareersController::class, 'edit'])->name('career.edit');
    Route::post('/admin/career/update', [CareersController::class, 'update'])->name('career.update');
    Route::get('/admin/career/disable/{package}', [CareersController::class, 'disable'])->name('career.disable');
    ...
    Route::get('/admin/packages/edit/{package}', [PackagesController::class, 'edit'])->name('packages.edit');
    ...
    Route::get('/admin/packages/programme/add/{package}', [PackagesController::class, 'programme'])->name('packages.programme.add');
    Route::get('/admin/packages/programme/edit/{package}', [PackagesController::class, 'editprog'])->name('packages.programme.editprog');
    ...
    Route::get('/admin/packages/gallery/show/{package}', [PackagesController::class, 'show_gallery'])->name('packages.gallery.show');
    Route::post('/admin/packages/gallery/save', [PackagesController::class, 'save_gallery'])->name('packages.gallery.save');
    Route::post('/admin/packages/gallery/edit/{package}', [PackagesController::class, 'edit_gallery'])->name('packages.gallery.edit');
    ...
    Route::get('/admin/packages/category/edit/{package}', [PackagesController::class, 'edit_category'])->name('categories.edit');
    Route::post('/admin/packages/update_category', [PackagesController::class, 'update_category'])->name('packages.update.category');
    Route::get('/admin/packages/category/disable{package}', [PackagesController::class, 'index'])->name('categories.disable');
    ...
    Route::get('/admin/blog/edit/{package}', [BlogController::class, 'edit'])->name('blog.edit');
    Route::post('/admin/blog/update', [BlogController::class, 'update'])->name('blog.update');
    Route::get('/admin/blog/delete/{package}', [BlogController::class, 'delete'])->name('blog.delete');
    ...
    Route::get('/admin/user/edit/{package}', [FaqsController::class, 'edit'])->name('user.edit');
    Route::post('/admin/user/update', [FaqsController::class, 'update'])->name('user.update');
    Route::get('/admin/user/disable/{package}', [FaqsController::class, 'disable'])->name('user.disable');
});
...
Route::middleware(['auth', 'user-access:manager'])->group(function () {
    ...
    Route::get('/manager/agencies/edit/{package}', [AgenciesController::class, 'edit'])->name('agencies.edit');
    Route::post('/manager/agencies/update', [AgenciesController::class, 'update'])->name('agencies.update');
    Route::get('/manager/agencies/delete/{package}', [AgenciesController::class, 'delete'])->name('agencies.delete');
    ...
    Route::get('/manager/packages/edit/{package}', [PackagesController::class, 'edit'])->name('packages.edit.manager');
    ...
    Route::get('/manager/packages/programme/add/{package}', [PackagesController::class, 'programme'])->name('packages.programme.add.manager');
    Route::get('/manager/packages/programme/edit/{package}', [PackagesController::class, 'editprog'])->name('packages.programme.editprog.manager');
    ...
    Route::get('/manager/packages/gallery/show/{package}', [PackagesController::class, 'show_gallery'])->name('packages.gallery.show.manager');
    Route::post('/manager/packages/gallery/save', [PackagesController::class, 'save_gallery'])->name('packages.gallery.save.manager');
    Route::post('/manager/packages/gallery/edit/{package}', [PackagesController::class, 'edit_gallery'])->name('packages.gallery.edit.manager');
